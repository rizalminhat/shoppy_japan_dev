...
class TrackingController extends Controller
{
    ...
    public function index(){
		...
		$listsubmitorder = DB::table('orders')
			...
			->select(DB::raw("order_no as order_no,submit_at as submit_at,order_status as order_status,orders.id as order_id, (SELECT SUM(items.item_total) from items where items.item_order_id=orders.id) as totalpay"))
			//->select('order_no as order_no','submit_at as submit_at','order_status as order_status','orders.id as order_id')
        ...
        return view('user.tracking.currenttracking',['listsubmitorder'=>$listsubmitorder, 'draftorder'=>$draftorder]);
    }
	/*
