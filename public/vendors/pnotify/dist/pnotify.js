	...
	var q = function (l) {
		...
		b.extend(d.prototype, {
			...
			init: function () {
				...
				this.title_container = b('<h6/>', { class: 'ui-pnotify-title' }).appendTo(
					this.container
				);
					...
					if (!d || c) {
						...
						if (
							...
							(a.nextpos1 = a.firstpos1),
								(a.nextpos2 +=
									a.addpos2 + ('undefined' === typeof a.spacing2 ? 25 : a.spacing2)),
								(a.addpos2 = 0);
						...
						switch (a.dir1) {
							...
							case 'up':
								a.nextpos1 +=
									b.height() + ('undefined' === typeof a.spacing1 ? 25 : a.spacing1);
								break;
							case 'left':
							case 'right':
								a.nextpos1 +=
									b.width() + ('undefined' === typeof a.spacing1 ? 25 : a.spacing1);
						}
					}
					return this;
				}
