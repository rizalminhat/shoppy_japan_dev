  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;background-color:#ededed;" >
              <a href="#" class="site_title"><img class="img-fluid mx-auto" src="{{ asset('main/img/logoshoppyJapan.png')}}" alt="Image" style="max-width: 90% !important"></a>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="{{asset('main/img/'.Auth::user()->admin_img)}}" alt="..." class="img-circle profile_img">
              </div>
        ...
        <!-- top navigation -->
        @include('admin.layouts.topnavigation')
        <!-- /top navigation -->
        ...
        <div class="right_col" role="main">
          ...
          <nav aria-label="breadcrumb" >
            <ol class="breadcrumb mb-0">
              {{-- <li class="breadcrumb-item"><a href="{{ route('admin.dashboard')}}"><i class="fa fa-home mr-2"></i>Main</a></li> --}}
    ...
    // var icon = {{ Session::get('alert-type')}};
    // console.log(icon);
    ...
    $("#checkall").change(function()
		{
			$(".checkboxtest").prop("checked", $(this).prop("checked"))
		})
		...
		$(".checkboxtest").change(function()
		{
			...
			if($(".checkboxtest:checked").length == $(".checkboxtest").length){
...
function getValueToDelete(link){
        ...
        {
        Swal.fire({
            title: 'Confirm delete selected data ?',
